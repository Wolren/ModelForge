...
class ModelForgeLinked:

    def __init__(self, iface):
        self.iface = iface
        self.plugin_dir = os.path.dirname(__file__)
        self.actions = []
        self.menu_name = u"&Model Forge Linked"
        self.dock = None
        self._provider = None

    def tr(self, message):
        return QCoreApplication.translate("ModelForgeLinked", message)
    ...
    def initGui(self):
        ...
        self.action_open = QAction(icon, self.tr(u"Model Forge Linked"), self.iface.mainWindow())
        self.action_open.setStatusTip(self.tr("Open Model Forge Linked panel"))
    ...
    def _load_user_algorithms(self):
        from .compiler_core.core.services.custom_step_author import _STEPS_DIR
        import warnings
        ...
        for fname in sorted(os.listdir(_STEPS_DIR)):
            ...
            try:
                ...
                warnings.warn(f"ModelForgeLinked: failed to register user step {fname}: {e}")
